...
class IngredientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should update ingredient" do
    patch ingredient_url(@ingredient), params: { ingredient: { ingredient_group_id: @ingredient.ingredient_group_id, quantity: @ingredient.quantity, title: @ingredient.title, unit_id: @ingredient.unit_id } }
